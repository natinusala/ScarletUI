...
public struct StatelessLeafSceneMakeInput<Value>: MakeInput where Value: Element {

}

public struct StatelessLeafSceneMakeOutput<Value, Edge>: MakeOutput where Value: Element, Edge: Element {
    let edge: Edge
}
