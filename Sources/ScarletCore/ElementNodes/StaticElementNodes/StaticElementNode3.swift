...
public struct StaticMakeInput3<Value>: ElementInput where Value: Element {

}

public struct StaticMakeOutput3<Value, E0, E1, E2>: ElementOutput where Value: Element, E0: Element, E1: Element, E2: Element {
    var e0: E0
    var e1: E1
    var e2: E2
}
