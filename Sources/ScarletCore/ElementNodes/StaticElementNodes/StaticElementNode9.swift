...
public class StaticElementNode9<Value, E0, E1, E2, E3, E4, E5, E6, E7, E8>: ElementNode where Value: Element, E0: Element, E1: Element, E2: Element, E3: Element, E4: Element, E5: Element, E6: Element, E7: Element, E8: Element, Value.Input == StaticMakeInput9<Value>, Value.Output == StaticMakeOutput9<Value, E0, E1, E2, E3, E4, E5, E6, E7, E8> {
    ...
    public func updateEdges(from output: Value.Output, at implementationPosition: Int) -> UpdateResult {
        ...
        if let e2 = self.e2 {
            e2ImplementationCount = e2.update(with: output.e2, compare: true, implementationPosition: e2ImplementationPosition).implementationCount
        } else {
        ...
        if let e3 = self.e3 {
            e3ImplementationCount = e3.update(with: output.e3, compare: true, implementationPosition: e3ImplementationPosition).implementationCount
        } else {
        ...
        if let e4 = self.e4 {
            e4ImplementationCount = e4.update(with: output.e4, compare: true, implementationPosition: e4ImplementationPosition).implementationCount
        } else {
        ...
        if let e5 = self.e5 {
            e5ImplementationCount = e5.update(with: output.e5, compare: true, implementationPosition: e5ImplementationPosition).implementationCount
        } else {
        ...
        if let e6 = self.e6 {
            e6ImplementationCount = e6.update(with: output.e6, compare: true, implementationPosition: e6ImplementationPosition).implementationCount
        } else {
        ...
        if let e7 = self.e7 {
            e7ImplementationCount = e7.update(with: output.e7, compare: true, implementationPosition: e7ImplementationPosition).implementationCount
        } else {
        ...
        if let e8 = self.e8 {
            e8ImplementationCount = e8.update(with: output.e8, compare: true, implementationPosition: e8ImplementationPosition).implementationCount
        } else {
            let edge = E8.makeNode(of: output.e8, in: self, implementationPosition: e8ImplementationPosition)
            self.e8 = edge
            e8ImplementationCount = edge.implementationCount
        }
