...
public struct StaticMakeInput4<Value>: ElementInput where Value: Element {

}

public struct StaticMakeOutput4<Value, E0, E1, E2, E3>: ElementOutput where Value: Element, E0: Element, E1: Element, E2: Element, E3: Element {
    var e0: E0
    var e1: E1
    var e2: E2
    var e3: E3
