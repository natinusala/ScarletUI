...
public struct StaticMakeInput2<Value>: ElementInput where Value: Element {

}

public struct StaticMakeOutput2<Value, E0, E1>: ElementOutput where Value: Element, E0: Element, E1: Element {
    var e0: E0
    var e1: E1
}
