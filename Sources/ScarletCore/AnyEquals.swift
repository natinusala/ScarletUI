...
/// Ignores component models' dynamic properties in the comparison (they are always considered equal).
...
/// Allows using ``anyEquals(lhs:rhs:)`` efficiently on stored values.
@propertyWrapper
