...
public struct LeafSceneComponentInput<Model>: ComponentInput where Model: ComponentModel {

}

public struct LeafSceneComponentOutput<Model, Edge>: ComponentOutput where Model: ComponentModel, Edge: ComponentModel {
    let edge: Edge
}

/// Component nodes for scenes that have a view as content. Does not perform equality check.
public class LeafSceneComponentNode<Model, Edge>: ComponentNode where Model: ComponentModel, Model.Input == LeafSceneComponentInput<Model>, Model.Output == LeafSceneComponentOutput<Model, Edge>, Edge: ComponentModel {
    ...
    public func make(component: Model) -> Model.Output {
        let input = LeafSceneComponentInput<Model>()
