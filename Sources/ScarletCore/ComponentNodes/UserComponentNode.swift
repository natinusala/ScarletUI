...
public struct UserComponentInput<Model>: ComponentInput where Model: ComponentModel {

}

public struct UserComponentOutput<Model, Edge>: ComponentOutput where Model: ComponentModel, Edge: ComponentModel {
    let edge: Edge
}

/// Component nodes for composable "user" components with a body (apps, scenes, views, view modifiers...). Always performs equality checks.
public class UserComponentNode<Model, Edge>: StatefulComponentNode where Model: ComponentModel, Model.Input == UserComponentInput<Model>, Model.Output == UserComponentOutput<Model, Edge>, Edge: ComponentModel {
    ...
    public func make(component: Model) -> Model.Output {
        let input = UserComponentInput<Model>()
