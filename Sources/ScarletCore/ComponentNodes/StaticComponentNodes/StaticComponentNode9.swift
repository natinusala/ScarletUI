...
public struct StaticComponentInput9<Model>: ComponentInput where Model: ComponentModel {

}

public struct StaticComponentOutput9<Model, E0, E1, E2, E3, E4, E5, E6, E7, E8>: ComponentOutput where Model: ComponentModel, E0: ComponentModel, E1: ComponentModel, E2: ComponentModel, E3: ComponentModel, E4: ComponentModel, E5: ComponentModel, E6: ComponentModel, E7: ComponentModel, E8: ComponentModel {
    var e0: E0
    var e1: E1
    var e2: E2
    var e3: E3
...
public class StaticComponentNode9<Model, E0, E1, E2, E3, E4, E5, E6, E7, E8>: ComponentNode where Model: ComponentModel, E0: ComponentModel, E1: ComponentModel, E2: ComponentModel, E3: ComponentModel, E4: ComponentModel, E5: ComponentModel, E6: ComponentModel, E7: ComponentModel, E8: ComponentModel, Model.Input == StaticComponentInput9<Model>, Model.Output == StaticComponentOutput9<Model, E0, E1, E2, E3, E4, E5, E6, E7, E8> {
    typealias Input = StaticComponentInput9<Model>
    typealias Output = StaticComponentOutput9<Model, E0, E1, E2, E3, E4, E5, E6, E7, E8>
    ...
    public func updateEdges(from output: Model.Output?, at targetPosition: Int, using context: Context) -> UpdateResult {
        ...
        // Edge 8
        let e8TargetPosition = targetPosition + totalTargetCount
        let e8TargetCount: Int
        if let e8 = self.e8 {
            e8TargetCount = e8.compareAndUpdate(
                with: output?.e8,
                targetPosition: e8TargetPosition,
                using: context
            ).targetCount
        } else if let output {
            let edge = E8.makeNode(of: output.e8, in: self, targetPosition: e8TargetPosition, using: context)
            self.e8 = edge
            e8TargetCount = edge.targetCount
        } else {
            nilOutputFatalError(for: E8.self)
        }
        totalTargetCount += e8TargetCount

        targetLogger.trace("\(E8.self) returned target count \(e8TargetCount) - Total: \(totalTargetCount)")
