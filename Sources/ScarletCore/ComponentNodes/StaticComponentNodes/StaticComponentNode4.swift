...
public struct StaticComponentInput4<Model>: ComponentInput where Model: ComponentModel {

}

public struct StaticComponentOutput4<Model, E0, E1, E2, E3>: ComponentOutput where Model: ComponentModel, E0: ComponentModel, E1: ComponentModel, E2: ComponentModel, E3: ComponentModel {
    var e0: E0
    var e1: E1
    var e2: E2
    var e3: E3
...
public class StaticComponentNode4<Model, E0, E1, E2, E3>: ComponentNode where Model: ComponentModel, E0: ComponentModel, E1: ComponentModel, E2: ComponentModel, E3: ComponentModel, Model.Input == StaticComponentInput4<Model>, Model.Output == StaticComponentOutput4<Model, E0, E1, E2, E3> {
    typealias Input = StaticComponentInput4<Model>
    typealias Output = StaticComponentOutput4<Model, E0, E1, E2, E3>
