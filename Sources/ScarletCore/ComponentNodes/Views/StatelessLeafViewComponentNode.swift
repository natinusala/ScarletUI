...
public struct StatelessLeafViewComponentInput<Model>: ComponentInput where Model: ComponentModel {

}

public struct StatelessLeafViewComponentOutput<Model>: ComponentOutput where Model: ComponentModel {

}

/// Component nodes for stateless leaf views that have no edges and no dynamic properties.
/// Performs an equality check on the component (see ``shouldUpdate(with:using:)``).
public class StatelessLeafViewComponentNode<Model>: ComponentNode where Model: ComponentModel, Model.Input == StatelessLeafViewComponentInput<Model>, Model.Output == StatelessLeafViewComponentOutput<Model> {
    ...
    public func make(component: Model) -> Model.Output {
        let input = StatelessLeafViewComponentInput<Model>()
