...
/// A view that applies 6 attributes to its content in an efficient way.
...
public struct ViewAttribute6<Content: View, A0: AttributeSetter, A1: AttributeSetter, A2: AttributeSetter, A3: AttributeSetter, A4: AttributeSetter, A5: AttributeSetter>: View {
...
public extension View {
    ...
    func attributed<A0: AttributeSetter, A1: AttributeSetter, A2: AttributeSetter, A3: AttributeSetter, A4: AttributeSetter, A5: AttributeSetter>(_ a0: A0, _ a1: A1, _ a2: A2, _ a3: A3, _ a4: A4, _ a5: A5) -> ViewAttribute6<Self, A0, A1, A2, A3, A4, A5> {
        return ViewAttribute6<Self, A0, A1, A2, A3, A4, A5>(content: self, a0: a0, a1: a1, a2: a2, a3: a3, a4: a4, a5: a5)
    }
}
