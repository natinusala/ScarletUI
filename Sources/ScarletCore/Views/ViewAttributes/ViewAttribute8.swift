...
/// A view that applies 8 attributes to its content in an efficient way.
...
public struct ViewAttribute8<Content: View, A0: AttributeSetter, A1: AttributeSetter, A2: AttributeSetter, A3: AttributeSetter, A4: AttributeSetter, A5: AttributeSetter, A6: AttributeSetter, A7: AttributeSetter>: View {
...
public extension View {
    func attributed<A0: AttributeSetter, A1: AttributeSetter, A2: AttributeSetter, A3: AttributeSetter, A4: AttributeSetter, A5: AttributeSetter, A6: AttributeSetter, A7: AttributeSetter>(_ a0: A0, _ a1: A1, _ a2: A2, _ a3: A3, _ a4: A4, _ a5: A5, _ a6: A6, _ a7: A7) -> ViewAttribute8<Self, A0, A1, A2, A3, A4, A5, A6, A7> {
        return ViewAttribute8<Self, A0, A1, A2, A3, A4, A5, A6, A7>(content: self, a0: a0, a1: a1, a2: a2, a3: a3, a4: a4, a5: a5, a6: a6, a7: a7)
    }
}
